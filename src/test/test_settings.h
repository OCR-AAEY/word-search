...
#define REPEAT                                                                 \
    for (size_t repeat_counter = 0; repeat_counter < TEST_ITERATION;           \
         repeat_counter++)
