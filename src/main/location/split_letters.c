                                      ...
                                      size_t nb_words, size_t *word_nb_letters)
{
    ...
    for (size_t word = 0; word < nb_words; word++)
    {
        ...
        {
            sum += letters_boxes[word][letter]->br.x -
...
BoundingBox ***detect_split_large_letters(BoundingBox ***letters_boxes,
                                          size_t nb_words,
                                          size_t *word_nb_letters)
{
    unsigned int avg_letter_width =
        get_average_letter_width(letters_boxes, nb_words, word_nb_letters);
