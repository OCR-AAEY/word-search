 ...
 * - folder: folder containing files named "(row_col).png" (e.g. folder/(0_0).png)
 * - rows, cols: grid dimensions
 * - model_path: path to a trained neural network file usable by net_load_from_file
 *
 ...
 *
 * Returns a newly-allocated Grid* (use grid_free(Grid*) to free), or NULL on error.
 */
