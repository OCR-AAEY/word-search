...
static ImageData *resize_image(ImageData *img)
{
    ...
    if (img->width <= TARGET_WIDTH)
        return load_image("assets/sample_images/level_2_image_1.png"); // fallback (will be overwritten)
...
static void activate(GtkApplication *app, gpointer user_data)
{
    ...
    gtk_entry_set_placeholder_text(widgets->path_entry, "e.g. assets/sample_images/pic.png");
...
{
    GtkApplication *app = gtk_application_new("com.example.rotationtool", G_APPLICATION_DEFAULT_FLAGS);
