...
int main(int argc, char *argv[]) {
    ...
    const char *step_image_paths[10] = {
        "assets/steps/1.png","assets/steps/2.png","assets/steps/3.png","assets/steps/4.png",
        "assets/steps/5.png","assets/steps/6.png","assets/steps/7.png","assets/steps/8.png",
    ...
    for(int i=0;i<10;i++){
        create_step_screen(stack, step_screens[i], step_screens[i], step_next[i], step_back[i],
                           i==0, step_image_paths[i],
    ...
    create_solve_screen(stack, "solve_load","solve_save","menu","assets/solved.png",
                        &solve_images[0], &solve_load_btn[0], &solve_next_btn[0], &solve_back_btn[0]);
